...
// //   `px-3 py-2 rounded-md text-sm font-medium ${isActive ? 'bg-indigo-600 text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700'}`;
...
//     isActive ? 'bg-indigo-600 text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-700'
//   }`;
...
//   return (
//     <nav className="bg-white dark:bg-gray-800 shadow fade-in">
//       <div className="container mx-auto px-4 flex items-center justify-between h-14">
//         <Link
//           to="/"
...
//     isActive ? 'bg-indigo-600 text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-indigo-100 dark:hover:bg-indigo-600 dark:hover:text-white'
//   }`;
